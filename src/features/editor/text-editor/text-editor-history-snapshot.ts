import { getTextOffsetFromPosition, getTextPositionFromOffset } from '~/domain/document/text-projection'

import type * as monaco from 'monaco-editor'
import type { EditorHistorySnapshot } from '~/domain/document/transaction'
