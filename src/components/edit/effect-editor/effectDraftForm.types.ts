import type { EffectSegmentedOption } from '~/composables/effect-editor/useEffectSegmentedControl'
import type {
  ChoiceField,
  ColorField,
  DialField,
  I18nLike,
  NumberField,
} from '~/helper/command-registry/schema'
import type { EffectRenderItem } from '~/helper/effect-editor-config'
